...
* [Broken link](/broken/pages/XpbH0VyXQYA9sdAJWhyQ "mention")
* [get-started-with-tac.md](../quickstart-testnet/get-started-with-tac.md "mention")
...
The `ERC721Ownership` condition checks the owner of a given token ID. It can be customized by using the `ownerOf` contract method and comparing it with the requestor's signature. For more information, see the [ContractCondition](../conditions/contractcondition/) section.
