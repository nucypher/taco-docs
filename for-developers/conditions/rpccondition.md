...
`':userAddress'` is a reserved [context variable](../authentication/conditioncontext-and-context-variables.md) that denotes the address of the operation requester. Before the attempt is made, the `':userAddress'` value will be replaced with the actual wallet address.
...
* [Broken link](/broken/pages/3qufTlyKsrLICoyVGk9J "mention")
