...
This section serves to explain the implicit and explicit trust assumptions baked into TACo, for both the [Mainnet](broken-reference) and [Testnet](../taco-integration/get-started-with-tac.md)[ ](broken-reference)versions. In later versions, these assumptions will be synthesized and exposed to the vast majority of adopting developers in the form of pre-configured network parameter packages.&#x20;
